...
import { _ as _imports_0$1 } from "./logo-199648a5.js";
import "ufo";
import "ofetch";
...
import "axios";
import "defu";
const sidebar_vue_vue_type_style_index_0_scoped_07bcf3a5_lang = "";
const _sfc_main$2 = {
  __name: "sidebar",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-[300px] h-screen bg-slate-200 p-4 shadow-md font-bold text-2xl" }, _attrs))} data-v-07bcf3a5><img${ssrRenderAttr("src", _imports_0$1)} alt="" data-v-07bcf3a5><ul class="m-5" data-v-07bcf3a5><!--[-->`);
      ssrRenderList(unref(posts), (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: item.name,
          to: item.path,
          class: [{ active: ("useRoute" in _ctx ? _ctx.useRoute : unref(useRoute))().path.includes(item.path) }, "admin-links hover:underline cursor-pointer flex flex-col"]
        }, {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-07bcf3a5"]]);
const _imports_0 = "" + __buildAssetsURL("logout.8e8b49fa.svg");
const _sfc_main$1 = {
  __name: "header",
  __ssrInlineRender: true,
  setup(__props) {
    useRoute();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="bg-gray-200 cursor-pointer w-full p-2 text-base font-semibold flex justify-between"><div>Admin Panel</div><div class="group relative flex gap-2 font-bold"><p>User</p><div class="absolute group-hover:block hidden top-6 -right-1/2 text-white h-10 w-[150px]"><div class="relative w-full h-full mt-4"><div class="items-center relative z-50 justify-center flex h-full text-sm bg-gray-600 rounded-md"> Hasapdan Cyk <img class="inline w-4 ml-2"${ssrRenderAttr("src", _imports_0)} alt=""></div><div class="absolute w-4 h-4 rotate-45 rounded-sm -top-2 translate-x-1/2 right-1/2 bg-gray-600"></div></div></div></div></div></div>`);
    };
  }
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_admin_header = _sfc_main$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-[1200px] mx-auto z-50" }, _attrs))}><div class="flex gap-4">`);
...
//# sourceMappingURL=admin-299aef14.js.map
