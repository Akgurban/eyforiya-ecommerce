  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(categories), (item) => {
        _push(`<div class="bg-gray-200 flex justify-between items-center text-lg font-bold rounded-md p-2 m-1"><img${ssrRenderAttr("src", `http://192.168.1.126:2000/api/v1/uploads/special_categories/${item == null ? void 0 : item.img_path}`)} alt="" class="h-10 w-15"><p>${ssrInterpolate(item.name)}</p>`);
...
//# sourceMappingURL=index-316cd804.js.map
