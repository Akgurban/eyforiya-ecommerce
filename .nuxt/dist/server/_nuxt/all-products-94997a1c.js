...
import { _ as _sfc_main$2 } from "./base-product-b39da0b5.js";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div></div></div>`);
      if (unref(showFilter)) {
        _push(`<div class="md:hidden block fixed w-[50%] 2xl:w-[25%] lg:w-[28%] shadow-2xl bottom-0 z-40 h-screen px-2 py-2 pb-10 bg-slate-100 rounded-md p-4"><div class="mt-15"><div class="md:text-xl text-base font-bold w-min uppercase whitespace-nowrap text-[#44A4DB] font-alatsi mb-2">${ssrInterpolate(_ctx.$t("category_select"))}</div><div class="ml-5"><!--[-->`);
        ssrRenderList(unref(categories).data, (item) => {
          _push(`<p class="font-alatsi font-semibold hover:text-[#44A4DB] cursor-auto md:cursor-pointer">${ssrInterpolate(item == null ? void 0 : item.name)}</p>`);
        });
        _push(`<!--]--></div></div></div>`);
...
//# sourceMappingURL=all-products-94997a1c.js.map
