...
import { _ as _sfc_main$1 } from "./TrashButtonAndCounter-939e9973.js";
import { _ as _sfc_main$2 } from "./base-button-598d851d.js";
import { ref, watch, withAsyncContext, mergeProps, withCtx, createTextVNode, unref, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="cursor-pointer font-bold">Add to cart</p></div><div class="w-full"><div class="w-full"><div class="bg-[#3C4242] text-white p-2 md:p-[26px] flex justify-between mt-10 px-3 md:px-10 w-full"><div></div><div class="flex justify-between w-full md:text-xl text-[10px]"><p class="uppercase">Product Details</p><p class="uppercase">Quantity</p><p class="uppercase">Price</p><p class="uppercase">Pozmak</p></div></div>`);
      if (!((_a2 = unref(trash).trash_items.products) == null ? void 0 : _a2.length)) {
        _push(`<div class="mt-20 text-center w-full text-6xl text-gray-500 font-alatsi font-bold"> SebediNiz Bosh </div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--[-->`);
      ...
      _push(`<!--]--><div class="bg-[#3C4242] text-white py-3 flex md:flex-row flex-col gap-y-4 justify-between w-full md:text-xl px-5 text-[10px]"><div class=""><p class="uppercase font-bold font-alatsi">Total Price:</p><p class="uppercase font-bold font-inter text-lg">${ssrInterpolate(unref(totalPrice))} TMT </p></div><div><p class="uppercase font-bold font-alatsi">Phone number:</p><div class="flex h-12 items-center justify-center text-black relative bg-white rounded-lg"><div class="h-full flex text-lg items-center mx-2">+993</div><input class="text-black text-lg bg-white outline-0 border-white" type="text"${ssrRenderAttr("value", unref(phone))} placeholder="6522222"></div></div>`);
      _push(ssrRenderComponent(_component_BaseButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Sargydy tayyarlamak`);
          } else {
            return [
              createTextVNode("Sargydy tayyarlamak")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-a7de564f.js.map
