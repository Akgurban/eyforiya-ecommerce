...
const profilSidebar_vue_vue_type_style_index_0_scoped_db0934ac_lang = "";
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "md:w-[400px] w-full md:h-screen h-auto md:sticky md:mb-10 bottom-0 bg-blue-50 shadow-md font-bold text-xl" }, _attrs))} data-v-db0934ac><ul class="md:m-5 flex md:flex-col flex-row gap-3 mt-3 justify-between md:justify-start" data-v-db0934ac><!--[-->`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-db0934ac"]]);
export {
  __nuxt_component_2 as _
};
//# sourceMappingURL=profil-sidebar-631bed53.js.map
