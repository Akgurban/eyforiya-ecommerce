...
import { _ as _sfc_main$2 } from "./TrashButtonAndCounter-939e9973.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_TrashButtonAndCounter = _sfc_main$2;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<img class="border w-full aspect-square select-none rounded-md md:rounded-lg border-[#e6e6e6]"${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/images/${(_a3 = unref(propItem)) == null ? void 0 : _a3.images}`)} alt="" height="262" loading="lazy"${_scopeId}><div class="w-fit mx-auto md:text-3xl text-base font-alatsi text-[#3C4242] mt-3 mb-1"${_scopeId}>${ssrInterpolate((_b = unref(propItem)) == null ? void 0 : _b.name)}</div><div class="mx-auto text-[#48BC4E] text-3xl font-alatsi w-fit pb-1 border-b border-[#44A4DB]"${_scopeId}>${ssrInterpolate((_c = unref(propItem)) == null ? void 0 : _c.price)} TMT </div>`);
          } else {
            return [
              createVNode("img", {
              ...
              createVNode("div", { class: "w-fit mx-auto md:text-3xl text-base font-alatsi text-[#3C4242] mt-3 mb-1" }, toDisplayString((_e = unref(propItem)) == null ? void 0 : _e.name), 1),
              createVNode("div", { class: "mx-auto text-[#48BC4E] text-3xl font-alatsi w-fit pb-1 border-b border-[#44A4DB]" }, toDisplayString((_f = unref(propItem)) == null ? void 0 : _f.price) + " TMT ", 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_IconLike, {
        ...
        class: [__props.item.isLiked ? "fill-red-600 text-red-600" : " text-white", "hover:text-red-600 w-7"]
      }, null, _parent));
      _push(`</div>`);
...
//# sourceMappingURL=base-product-09b837b4.js.map
