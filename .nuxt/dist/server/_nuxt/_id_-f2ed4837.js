...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    try {
      ...
      const { data } = ([__temp, __restore] = withAsyncContext(() => userStore.OneBanner(route.params.id)), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_BaseImgUpload, {
        currentImg: `http://192.168.1.126:2000/api/v1/uploads/banners/${unref(selectedImg)}`,
...
//# sourceMappingURL=_id_-f2ed4837.js.map
