...
import { _ as __nuxt_component_2$1 } from "./TrashButtonAndCounter-1ad512d4.js";
...
import { a as _imports_0, _ as _sfc_main$3 } from "./base-product-da75b566.js";
...
import "devalue";
import "klona";
import { b as useSessionStorage, S as StorageSerializers } from "./trash-594b124b.js";
...
const _id__vue_vue_type_style_index_0_scoped_2acb38c4_lang = "";
const _sfc_main = {
  __name: "[id]",
  ...
  async setup(__props) {
    ...
    useHead({
      ...
      meta: [{ name: "description", content: (_c = oneProduct.value) == null ? void 0 : _c.description }]
    });
    return (_ctx, _push, _parent, _attrs) => {
      var _a2, _b2;
      const _component_IconLike = _sfc_main$2;
      const _component_TrashButtonAndCounter = __nuxt_component_2$1;
      const _component_IconSend = __nuxt_component_2;
      const _component_BaseProduct = _sfc_main$3;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-2acb38c4><div class="group aspect-[video] w-screen 2xl:w-[1428px] mx-auto flex justify-between items-start px-4 sm:flex-row flex-col" data-v-2acb38c4><div class="sm:w-[35%] w-full relative" data-v-2acb38c4><img${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/images/${(_a2 = unref(selectedImg)) == null ? void 0 : _a2.img_path}`)} class="w-full one_img rounded-md aspect-square" alt="" data-v-2acb38c4>`);
      if ((_b2 = _ctx.propItem) == null ? void 0 : _b2.status) {
        _push(`<div class="absolute -top-[10px] -left-[11px]" data-v-2acb38c4><img class="md:w-25 w-18"${ssrRenderAttr("src", _imports_0)} alt="" data-v-2acb38c4></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="absolute top-5 right-5" data-v-2acb38c4>`);
      _push(ssrRenderComponent(_component_IconLike, {
        fill: "none",
        onClick: ($event) => toggleFav(unref(oneProduct)),
        class: [
          unref(oneProduct).isLiked ? "fill-red-600 text-red-600" : " text-gray-400",
          "group-hover:text-red-600 w-7"
        ]
      }, null, _parent));
      _push(`</div><div class="w-full relative mt-5 flex justify-start" data-v-2acb38c4><!--[-->`);
      ssrRenderList(unref(oneProduct).images, (item) => {
        _push(`<img${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/images/${item == null ? void 0 : item.img_path}`)} class="w-[19%] rounded-md aspect-square mr-2 border border-blue-200" alt="" data-v-2acb38c4>`);
      });
      _push(`<!--]--></div></div><div class="w-[60%] sm:ml-6 ml-0 mt-6" data-v-2acb38c4><div data-v-2acb38c4><div class="one_prod w-fit cursor-pointer transition-all duration-100 hover:text-[#44A4DB] md:text-5xl text-2xl mb-1 font-semibold font-inter" data-v-2acb38c4>${ssrInterpolate(unref(oneProduct).name)}</div><div class="sm:pt-1.5 pt-0 pb-1.5 md:text-xl text-lg sm:font-normal font-medium" data-v-2acb38c4>${ssrInterpolate(unref(oneProduct).description)}</div><div class="flex items-center flex-wrap sm:px-4 px-1 py-2 border-t border-b border-gray-200" data-v-2acb38c4><div class="text-white cursor-pointer rounded-md text-2xl px-4 py-3 bg-[#44A4DB]" data-v-2acb38c4>${ssrInterpolate(unref(oneProduct).price)} TMT </div></div><div class="md:ml-5 ml-1 pt-3 w-55" data-v-2acb38c4>`);
      ...
      _push(`</div><div data-v-2acb38c4><p data-v-2acb38c4>${ssrInterpolate(_ctx.$t("comment"))}</p><div class="min-w-[300px] w-auto flex gap-4" data-v-2acb38c4><textarea class="border border-[#44A4DB] p-2" type="text" data-v-2acb38c4>${ssrInterpolate(unref(comment))}</textarea>`);
      _push(ssrRenderComponent(_component_IconSend, {
        onClick: sendComment,
        class: "md:cursor-pointer self-end cursor-auto text-[#44A4DB] fill-[#44A4DB]"
      }, null, _parent));
      _push(`</div></div></div></div></div><div class="w-screen 2xl:w-[1428px] mx-auto px-4 sm:flex-row flex-col" data-v-2acb38c4><div class="bg-teal-100 mt-6" data-v-2acb38c4><p class="font-alatsi font-bold p-2 uppercase" data-v-2acb38c4>${ssrInterpolate(_ctx.$t("comments"))}</p><ul data-v-2acb38c4><!--[-->`);
      ssrRenderList(unref(comments).data.comments, (item, index) => {
        _push(`<li class="odd:bg-teal-50 even:bg-teal-100 p-2 font-inter" data-v-2acb38c4>${ssrInterpolate(index + 1)}: ${ssrInterpolate(item.content)}</li>`);
      });
      _push(`<!--]--></ul></div><div class="mt-8 px-0 md:px-10 cursor-pointer transition-all duration-100 md:text-4xl text-2xl mb-1 font-semibold font-inter" data-v-2acb38c4>${ssrInterpolate(_ctx.$t("similar_products"))}</div><div style="${ssrRenderStyle({})}" class="flex flex-wrap justify-start md:px-1 mt-2 gap-2 md:gap-3" data-v-2acb38c4><!--[-->`);
      ssrRenderList(unref(similarProducts), (item, index) => {
        _push(`<div class="group relative md:w-[265px] w-[176px] product_item mb-3 hover:shadow-none md:hover:shadow-hero bg-[#D9D9D940] hover:bg-[#D9D9D940] transition-all ease-in-out duration-200 rounded-xl flex flex-col justify-between items-center" data-v-2acb38c4>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2acb38c4"]]);
export {
  _id_ as default
};
//# sourceMappingURL=_id_-e9b9fb40.js.map
