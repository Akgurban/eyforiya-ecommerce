  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!props.show_filter) {
        _push(`<div class="lg:relative md:pt-10 pt-20 overflow-auto fixed shadow-2xl top-0 z-40 h-screen px-3 py-3 lg:block pb-10 bg-slate-100 rounded-md p-4"><div><div class="md:text-2xl text-xl uppercase text-[#44A4DB] font-alatsi mb-2">${ssrInterpolate(_ctx.$t("order"))}</div><div><!--[-->`);
        ssrRenderList(unref(orderList), (item) => {
          ...
          _push(`<div class="font-alatsi text-base">${ssrInterpolate(_ctx.$t(item.name))}</div></div>`);
        });
        _push(`<!--]--></div></div>`);
        if (__props.show_cat) {
          _push(`<div class="mt-5"><div class="md:text-2xl text-xl uppercase text-[#44A4DB] font-alatsi mb-2">${ssrInterpolate(_ctx.$t("in_category"))}</div>`);
        ...
        _push(`<div class="relative mt-5"><div class="md:text-2xl text-xl uppercase text-[#44A4DB] font-alatsi mb-2">${ssrInterpolate(_ctx.$t("brands"))}</div><div><div class="right-0 border-t-2 h-auto duration-250 ease-in-out z-10 w-full"><!--[-->`);
...
//# sourceMappingURL=FilteredSidebar-36fa68a0.js.map
