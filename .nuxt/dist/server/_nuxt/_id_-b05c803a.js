...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div><div class="my-4 font-bold bg-slate-300 p-2">Haryt gosun</div><div class="flex gap-4 justify-between w-full"><div class="w-[400px] flex flex-col gap-3">`);
...
//# sourceMappingURL=_id_-b05c803a.js.map
