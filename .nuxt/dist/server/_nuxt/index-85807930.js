...
import { _ as _sfc_main$7 } from "./base-product-b39da0b5.js";
...
const HeroSwiperCategory_vue_vue_type_style_index_0_scoped_6fa99b8a_lang = "";
const _sfc_main$5 = {
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(categories).data, (item) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="rounded-xl mb-3 text-center mt-6" data-v-6fa99b8a${_scopeId2}><img class="border rounded-md md:rounded-lg border-[#e6e6e6] w-[262px] h-[210px] md:h-[262px] object-cover"${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/categories/${item.img_path}`)} alt="" loading="lazy" data-v-6fa99b8a${_scopeId2}><div class="md:text-xl text-base font-semibold font-alatsi text-[#3C4242] mt-0 md:mt-3 mb-1" data-v-6fa99b8a${_scopeId2}>${ssrInterpolate(item.name)}</div></div>`);
                  } else {
                    return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-6fa99b8a"]]);
const _sfc_main$4 = {
  __name: "MainInfo",
  __ssrInlineRender: true,
  props: {
...
const HeroSwiperProduct_vue_vue_type_style_index_0_scoped_f14730aa_lang = "";
const _sfc_main$3 = {
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f14730aa"]]);
const _sfc_main$2 = {
  __name: "HeroSpecials",
  __ssrInlineRender: true,
  props: {
...
const index_vue_vue_type_style_index_0_scoped_13bcce1d_lang = "";
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-13bcce1d><div class="xl:w-[1196px] rounded-md overflow-hidden select-none w-full aspect-[21/10] mx-auto" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_MainSwiper, null, null, _parent));
      _push(`</div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-13bcce1d><div class="flex justify-between items-center" data-v-13bcce1d><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-13bcce1d>${ssrInterpolate(_ctx.$t("categories"))}</p><div class="flex cursor-pointer items-center" data-v-13bcce1d><p class="font-alatsi font-semibold inline md:text-2xl text-base text-[#3C4242]" data-v-13bcce1d>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-13bcce1d></div></div><div class="md:h-[358px] h-[250px] md:mt-7 mt-1" data-v-13bcce1d><div class="block md:hidden" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_HeroSwiperCategory, { count: 2 }, null, _parent));
      _push(`</div><div class="md:block hidden" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_HeroSwiperCategory, {
        class: "hidden",
        count: 4
      }, null, _parent));
      _push(`</div></div></div><div class="block xl:w-[1238px] md:w-full w-full mx-auto mt-4 md:mt-[100px]" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_MainInfo, {
        rating: (_a = unref(rating)) == null ? void 0 : _a.data
      }, null, _parent));
      _push(`</div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-13bcce1d><div class="flex justify-between items-center" data-v-13bcce1d><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-13bcce1d>${ssrInterpolate(_ctx.$t("latest_products"))}</p><div class="flex cursor-pointer items-center" data-v-13bcce1d><p class="font-alatsi font-semibold inline md:text-2xl text-base text-[#3C4242]" data-v-13bcce1d>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-13bcce1d></div></div><div class="block md:h-auto h-auto md:mt-7 mt-3" data-v-13bcce1d><div class="md:block hidden" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_HeroSwiperProduct, {
        products: unref(latest).data,
        count: "4"
      }, null, _parent));
      _push(`</div><div class="block md:hidden" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_HeroSwiperProduct, {
        products: unref(latest).data,
        count: "2"
      }, null, _parent));
      _push(`</div></div></div><div class="block h-auto xl:w-[1238px] w-screen mx-auto md:mt-[92px]" data-v-13bcce1d><div class="flex justify-center" data-v-13bcce1d><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-13bcce1d>${ssrInterpolate(_ctx.$t("specials"))}</p></div><div class="h-auto w-full md:mt-7 mt-3" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_HeroSpecials, {
        specials: unref(special_categories).data,
        class: ""
      }, null, _parent));
      _push(`</div></div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-13bcce1d><div class="flex justify-between items-center" data-v-13bcce1d><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-13bcce1d>${ssrInterpolate(_ctx.$t("special_products"))}</p><div class="flex cursor-pointer items-center" data-v-13bcce1d><p class="font-alatsi font-semibold inline md:text-2xl text-base text-[#3C4242]" data-v-13bcce1d>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-13bcce1d></div></div><div class="block md:h-auto h-auto md:mt-7 mt-1" data-v-13bcce1d><div class="md:block hidden" data-v-13bcce1d>`);
      _push(ssrRenderComponent(_component_HeroSwiperProduct, {
      ...
      _push(`</div></div></div><div class="flex items-center gap-7 md:gap-14 2xl:w-[1440px] w-screen overflow-hidden mx-auto mt-4 md:mt-[92px] h-[125px]" data-v-13bcce1d><div class="flex justify-around md:min-w-full w-fit gap-7 md:gap-14 animation_brands" data-v-13bcce1d><!--[-->`);
      ssrRenderList(unref(main_brands).data, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img class="text-black aspect-auto object-cover hover:grayscale-0 transition-all duration-75 cursor-pointer h-[90px] min-w-[80px] rounded-md"${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/brands/${item == null ? void 0 : item.img_path}`)} alt="" data-v-13bcce1d${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
      ...
      _push(`<!--]--></div><div class="flex justify-around md:min-w-full w-fit gap-7 md:gap-14 animation_brands" data-v-13bcce1d><!--[-->`);
      ssrRenderList(unref(main_brands).data, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          onClick: ($event) => ("useRouter" in _ctx ? _ctx.useRouter : unref(useRouter))().push(
            _ctx.localePath({
      ...
      _push(`<!--]--></div></div><div class="xl:w-[1196px] mt-10 rounded-md overflow-hidden select-none w-full aspect-[21/10] mx-auto" data-v-13bcce1d>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-13bcce1d"]]);
export {
  index as default
};
//# sourceMappingURL=index-85807930.js.map
