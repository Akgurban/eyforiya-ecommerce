...
import "defu";
const sidebar_vue_vue_type_style_index_0_scoped_4a62032d_lang = "";
const _sfc_main$3 = {
  __name: "sidebar",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-[300px] h-screen bg-slate-200 p-4 shadow-md font-bold text-2xl" }, _attrs))} data-v-4a62032d><img class="mx-auto md:cursor-pointer cursor-auto"${ssrRenderAttr("src", _imports_0)} alt="" data-v-4a62032d><ul class="m-5" data-v-4a62032d><!--[-->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-4a62032d"]]);
const _sfc_main$2 = {
  __name: "header",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=admin-f81a13d1.js.map
