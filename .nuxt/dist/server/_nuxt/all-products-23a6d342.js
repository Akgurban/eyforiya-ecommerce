...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="w-full"><div style="${ssrRenderStyle({ "padding-bottom": "20px !important" })}" class="flex w-full flex-wrap gap-3 mx-auto justify-start mt-5"><!--[-->`);
...
//# sourceMappingURL=all-products-23a6d342.js.map
