...
import { _ as _sfc_main$2 } from "./FilteredSidebar-36fa68a0.js";
...
const _id__vue_vue_type_style_index_0_scoped_864c2cb2_lang = "";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "2xl:w-[1440px] xl:screen mx-auto" }, _attrs))} data-v-864c2cb2><div class="flex justify-between px-3" data-v-864c2cb2><div data-v-864c2cb2></div>`);
      _push(ssrRenderComponent(_component_BaseButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-864c2cb2${_scopeId}>${ssrInterpolate(!unref(showFilter) ? _ctx.$t("close_filter") : _ctx.$t("show_filter"))}</p><img${ssrRenderAttr("src", _imports_0)} class="inline w-5" alt="" data-v-864c2cb2${_scopeId}>`);
          } else {
            return [
      ...
      _push(`</div><div class="lead flex gap-5" data-v-864c2cb2><div class="md:block hidden w-full 2xl:w-[25%] lg:w-[28%]" data-v-864c2cb2>`);
      ...
      _push(`</div><div class="block md:hidden absolute w-full 2xl:w-[25%] lg:w-[28%]" data-v-864c2cb2>`);
      _push(ssrRenderComponent(_component_filtered_sidebar, {
        show_filter: unref(showFilter),
        show_cat: false,
        brands: unref(brands).data,
      ...
      _push(`</div><div style="${ssrRenderStyle({ "width": "96% !important", "height": "auto !important", "user-select": "none !important", "padding-bottom": "20px !important" })}" class="flex flex-wrap gap-3 justify-between mx-auto mt-5" data-v-864c2cb2><!--[-->`);
      ssrRenderList((_c2 = unref(incomedDatas)) == null ? void 0 : _c2.products, (item, index) => {
        _push(`<div draggable="true" class="group relative md:w-[266px] w-[176px] product_item mb-3 hover:shadow-none md:hover:shadow-hero hover:bg-[#D9D9D940] transition-all ease-in-out duration-200 rounded-xl flex flex-col justify-between items-center" data-v-864c2cb2>`);
        _push(ssrRenderComponent(_component_BaseProduct, { item }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]-->`);
      if (!((_d = unref(incomedDatas)) == null ? void 0 : _d.products)) {
        _push(`<div class="mt-20 text-center w-full text-6xl text-gray-500 font-alatsi font-bold" data-v-864c2cb2>${ssrInterpolate(_ctx.$t("no_product"))}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-864c2cb2"]]);
export {
  _id_ as default
};
//# sourceMappingURL=_id_-7327d361.js.map
