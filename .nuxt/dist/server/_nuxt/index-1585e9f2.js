...
import { _ as _sfc_main$1 } from "./base-product-da75b566.js";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p class="cursor-pointer font-bold">${ssrInterpolate(_ctx.$t("favourites"))}</p></div><div class="w-full flex gap-3 flex-wrap my-5 md:justify-start justify-start px-3">`);
...
//# sourceMappingURL=index-1585e9f2.js.map
