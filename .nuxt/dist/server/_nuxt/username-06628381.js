...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_IconChevronRight, { class: "h-3" }, null, _parent));
      _push(`<p class="cursor-pointer font-bold">${ssrInterpolate(_ctx.$t("history"))}</p></div><div class="flex md:flex-row flex-col gap-4 mt-3"><div class="">`);
      _push(ssrRenderComponent(_component_profil_sidebar, null, null, _parent));
      _push(`</div><div class="md:w-[900px] w-full"><div class="h-[96vh] overflow-auto"><div class="text-2xl md:text-4xl font-bold mt-6 text-blue-900"> Username recover </div><form class="mt-10 md:mt-20"><div class="pl-2 md:pl-10 w-[70%]"><p class="text-blue-800 font-bold">username tazele</p><input${ssrRenderAttr("value", unref(password))} type="primary" label="passwordy tazele" class="border-2 border-blue-800 rounded-full p-2"></div><div class="pl-2 md:pl-10 w-[70%] mt-8"><p class="text-blue-800 font-bold">username tazeden girizin</p><input${ssrRenderAttr("value", unref(password2))} type="primary" label="passwordy tazele" class="border-2 border-blue-800 rounded-full p-2"></div><div class="mt-5 ml-auto w-fit">`);
...
//# sourceMappingURL=username-06628381.js.map
