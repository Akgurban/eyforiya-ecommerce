import { unref, getCurrentScope, onScopeDispose, ref, readonly, watch, reactive, computed, shallowRef, nextTick } from "vue";
...
const useTrashStore = defineStore("trash", {
  ...
  actions: {
    async setLocalStorage(propItem, count) {
      var _a, _b;
      if (count > 1) {
        (_a = this.trash_items.products) == null ? void 0 : _a.filter((item, index) => {
        ...
        const some = {
          uuid: propItem == null ? void 0 : propItem.uuid,
          count,
          images: propItem == null ? void 0 : propItem.images,
          price: propItem == null ? void 0 : propItem.price,
          name: propItem == null ? void 0 : propItem.name
        };
        (_b = this.trash_items.products) == null ? void 0 : _b.push(some);
      }
    ...
    async removeLocalStorage(propItem, count) {
      ...
      if (count > 0) {
        ...
        (_b = this.trash_items.products) == null ? void 0 : _b.filter((item, index) => {
          var _a2, _b2;
          if ((propItem == null ? void 0 : propItem.uuid) == (item == null ? void 0 : item.uuid)) {
            (_b2 = (_a2 = this.trash_items) == null ? void 0 : _a2.products) == null ? void 0 : _b2.splice(index, 1);
          }
        });
      }
      this.trash_items.totalCount -= 1;
