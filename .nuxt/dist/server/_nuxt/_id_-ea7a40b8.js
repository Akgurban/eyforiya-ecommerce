  ...
  async setup(__props) {
    ...
    try {
      ...
      selectedCategory.value = {
        name: (_a = data == null ? void 0 : data.data) == null ? void 0 : _a.category_name,
        uuid: (_b = data == null ? void 0 : data.data) == null ? void 0 : _b.category_id
      };
    } catch (error) {
      console.log(error);
    }
...
//# sourceMappingURL=_id_-ea7a40b8.js.map
