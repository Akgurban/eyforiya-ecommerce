...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="md:w-[900px] w-full"><div class="h-[96vh] overflow-auto"><div class="text-2xl md:text-4xl font-bold mt-6 text-blue-900">${ssrInterpolate(_ctx.$t("pass_rec"))}</div><form class="md:mt-20 mt-10"><div class="pl-2 md:pl-10 w-[70%]"><p class="text-blue-800 font-bold">${ssrInterpolate(_ctx.$t("new_pass"))}</p><input${ssrRenderAttr("value", unref(password))} type="password" class="border-2 border-blue-800 rounded-full p-2">`);
      if (unref(pending1)) {
      ...
      _push(`</div><div class="pl-2 md:pl-10 w-[70%] mt-8"><p class="text-blue-800 font-bold">${ssrInterpolate(_ctx.$t("rew_pass"))}</p><input${ssrRenderAttr("value", unref(password2))} type="password" label="passwordy tazele" class="border-2 border-blue-800 rounded-full p-2">`);
      if (unref(pending1)) {
        _push(ssrRenderComponent(_component_BaseButton, {
          type: "danger",
          class: "m-6 inline rounded-full"
...
//# sourceMappingURL=password-fe1d3614.js.map
