...
import { l as useSwitchLocalePath$1, a as useRoute, b as useRouter, m as getComposer, h as useNuxtApp, f as useI18n, _ as _export_sfc } from "../server.mjs";
import { useSSRContext, mergeProps, unref, withCtx, createVNode, toDisplayString, ref, openBlock, createBlock, createCommentVNode, createTextVNode } from "vue";
import "destr";
import "devalue";
import "klona";
import "js-cookie";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        class: [
          unref(route).path == "/trash" || unref(route).path == "/en/trash" || unref(route).path == "/ru/trash" || unref(trash).trash_items.totalCount !== 0 ? "bg-[#44A4DB] text-white " : "bg-[#F6F6F6] text-[#807D7E]",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(trash).trash_items.totalCount !== 0) {
              _push2(`<div class="absolute -top-4 left-0 rounded-full bg-[#F35528] text-white w-7 h-7 flex justify-center items-center"${_scopeId}>${ssrInterpolate(unref(trash).trash_items.totalCount)}</div>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
            return [
              ...
              unref(trash).trash_items.totalCount !== 0 ? (openBlock(), createBlock("div", {
                key: 0,
                class: "absolute -top-4 left-0 rounded-full bg-[#F35528] text-white w-7 h-7 flex justify-center items-center"
              }, toDisplayString(unref(trash).trash_items.totalCount), 1)) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "lg:mt-0 mt-2 flex lg:flex-row flex-col items-center w-full pb-2 border-b-2 border-[#f6f6f6] justify-between" }, _attrs))}><div class="flex justify-between items-center w-full lg:mt-3 mt-0"><img${ssrRenderAttr("src", _imports_0$2)} alt="" draggable="false" style="${ssrRenderStyle({})}" class="cursor-pointer select-none lg:h-[64px] h-[42px]"><div class="lg:hidden block">`);
  _push(ssrRenderComponent(_component_HeaderLangs, null, null, _parent));
  _push(`</div></div><div class="flex items-center justify-between w-full lg:my-0 lg:mt-3 mt-3 gap-4"><div class="h-fit lg:w-[200px] xl:w-[386px] w-full lg:mr-[14px] mr-auto">`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class=""><div class="sticky top-0 left-0 z-40 bg-white 2xl:w-[1428px] w-full mx-auto md:px-8 px-4 shadow-md">`);
      _push(ssrRenderComponent(_component_MainHeader, { class: "" }, null, _parent));
      _push(`</div><div><ul class="justify-center font-semibold font-inter my-2 flex text-[#474747] md:text-[20px] text-base md:gap-[23px] gap-3"><!--[-->`);
...
//# sourceMappingURL=default-655e27f2.js.map
