...
import { _ as _sfc_main$2 } from "./FilteredSidebar-33b579c8.js";
...
const _id__vue_vue_type_style_index_0_scoped_cbaee84a_lang = "";
...
const _sfc_main = {
  ...
  async setup(__props) {
      ...
      async () => {
        ...
        if (count.value <= Math.floor(((_a2 = incomedDatas.value) == null ? void 0 : _a2.product_count) / limit.value)) {
          ...
          if (status) {
            ...
            console.log(count.value, Math.floor(((_f = incomedDatas.value) == null ? void 0 : _f.product_count) / limit.value) + 1);
            (_g = data.value) == null ? void 0 : _g.data.products.forEach((e) => incomedDatas.value.products.push(e));
          }
        }
      },
      // setTimeout(async() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "2xl:w-[1440px] xl:screen mx-auto" }, _attrs))} data-v-cbaee84a><div class="flex justify-between" data-v-cbaee84a><div data-v-cbaee84a></div>`);
      _push(ssrRenderComponent(_component_BaseButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-cbaee84a${_scopeId}>${ssrInterpolate(unref(showFilter) ? _ctx.$t("close_filter") : _ctx.$t("show_filter"))}</p><img${ssrRenderAttr("src", _imports_0)} class="inline w-5" alt="" data-v-cbaee84a${_scopeId}>`);
          } else {
            return [
      ...
      _push(`</div><div class="lead flex gap-5" data-v-cbaee84a><div class="md:block hidden w-full 2xl:w-[25%] lg:w-[28%] z-20" data-v-cbaee84a>`);
      ...
      _push(`</div><div class="md:hidden absolute block w-full 2xl:w-[25%] lg:w-[28%]" data-v-cbaee84a>`);
      _push(ssrRenderComponent(_component_filtered_sidebar, {
      ...
      _push(`</div><div class="w-full h-[80vh] overflow-auto" data-v-cbaee84a><div style="${ssrRenderStyle({ "padding-bottom": "20px !important" })}" class="flex w-full flex-wrap gap-3 md:justify-start justify-center mt-2 mx-auto" data-v-cbaee84a><!--[-->`);
      ssrRenderList((_e = unref(incomedDatas)) == null ? void 0 : _e.products, (item, index) => {
        _push(`<div draggable="true" class="group relative md:w-[266px] w-[176px] product_item mb-3 hover:shadow-none md:hover:shadow-hero hover:bg-[#D9D9D940] transition-all ease-in-out duration-200 rounded-xl flex flex-col justify-between items-center" data-v-cbaee84a>`);
        _push(ssrRenderComponent(_component_BaseProduct, { item }, null, _parent));
        _push(`</div>`);
      });
      _push(`<!--]--><br data-v-cbaee84a>`);
      if (unref(ShowLoader)) {
        _push(`<div class="w-full" data-v-cbaee84a><img${ssrRenderAttr("src", _imports_0$1)} class="mx-auto" alt="" data-v-cbaee84a></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!((_f = unref(incomedDatas)) == null ? void 0 : _f.products)) {
        _push(`<div class="mt-20 text-center w-full text-6xl text-gray-500 font-alatsi font-bold" data-v-cbaee84a>${ssrInterpolate(_ctx.$t("no_product"))}</div>`);
      } else {
        _push(`<!---->`);
      }
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cbaee84a"]]);
export {
  _id_ as default
};
//# sourceMappingURL=_id_-3cae7420.js.map
