...
import { _ as _sfc_main$7 } from "./base-product-aed4d765.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(icons), (item) => {
        _push(`<div class="flex items-center my-2 md:flex-row flex-col"><img${ssrRenderAttr("src", item.img)} alt=""><div class="text-center ml-3"><p class="font-alatsi md:text-[45px] font-bold text-2xl text-[#3C4242] leading-[33px]">${ssrInterpolate(item.name)}</p><p class="font-alatsi font-medium text-base text-[#000] mt-2 w-[150px]">${ssrInterpolate(_ctx.$t(item.desc))}</p></div></div>`);
      });
      _push(`<!--]--></div>`);
    };
  }
...
const index_vue_vue_type_style_index_0_scoped_d8c4d8ba_lang = "";
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-d8c4d8ba><div class="xl:w-[1196px] rounded-md overflow-hidden select-none w-full aspect-[21/10] mx-auto" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_MainSwiper, null, null, _parent));
      _push(`</div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-d8c4d8ba><div class="flex justify-between items-center" data-v-d8c4d8ba><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-d8c4d8ba>${ssrInterpolate(_ctx.$t("categories"))}</p><div class="flex cursor-pointer items-center" data-v-d8c4d8ba><p class="font-alatsi font-semibold inline md:text-2xl text-base text-[#3C4242]" data-v-d8c4d8ba>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-d8c4d8ba></div></div><div class="md:h-[358px] h-[250px] md:mt-7 mt-1" data-v-d8c4d8ba><div class="block md:hidden" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_HeroSwiperCategory, { count: 2 }, null, _parent));
      _push(`</div><div class="md:block hidden" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_HeroSwiperCategory, {
        class: "hidden",
        count: 4
      }, null, _parent));
      _push(`</div></div></div><div class="block xl:w-[1238px] md:w-full w-full mx-auto mt-4 md:mt-[100px]" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_MainInfo, {
        rating: (_a = unref(rating)) == null ? void 0 : _a.data
      }, null, _parent));
      _push(`</div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-d8c4d8ba><div class="flex justify-between items-center" data-v-d8c4d8ba><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-d8c4d8ba>${ssrInterpolate(_ctx.$t("latest_products"))}</p><div class="flex cursor-pointer items-center" data-v-d8c4d8ba><p class="font-alatsi font-semibold inline md:text-2xl text-base text-[#3C4242]" data-v-d8c4d8ba>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-d8c4d8ba></div></div><div class="block md:h-auto h-auto md:mt-7 mt-3" data-v-d8c4d8ba><div class="md:block hidden" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_HeroSwiperProduct, {
        products: unref(latest).data,
        count: 4
      }, null, _parent));
      _push(`</div><div class="block md:hidden" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_HeroSwiperProduct, {
        products: unref(latest).data,
        count: 2
      }, null, _parent));
      _push(`</div></div></div><div class="block h-auto xl:w-[1238px] w-screen mx-auto md:mt-[92px]" data-v-d8c4d8ba><div class="flex justify-center" data-v-d8c4d8ba><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-d8c4d8ba>${ssrInterpolate(_ctx.$t("specials"))}</p></div><div class="h-auto w-full md:mt-7 mt-3" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_HeroSpecials, {
        specials: unref(special_categories).data,
        class: ""
      }, null, _parent));
      _push(`</div></div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-d8c4d8ba><div class="flex justify-between items-center" data-v-d8c4d8ba><p class="font-alatsi font-semibold md:text-2xl text-base text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[6px]" data-v-d8c4d8ba>${ssrInterpolate(_ctx.$t("special_products"))}</p><div class="flex cursor-pointer items-center" data-v-d8c4d8ba><p class="font-alatsi font-semibold inline md:text-2xl text-base text-[#3C4242]" data-v-d8c4d8ba>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-d8c4d8ba></div></div><div class="block md:h-auto h-auto md:mt-7 mt-1" data-v-d8c4d8ba><div class="md:block hidden" data-v-d8c4d8ba>`);
      _push(ssrRenderComponent(_component_HeroSwiperProduct, {
      ...
      _push(`</div></div></div><div class="flex items-center gap-7 md:gap-14 2xl:w-[1440px] w-screen overflow-hidden mx-auto mt-4 md:mt-[92px] h-[125px]" data-v-d8c4d8ba><div class="flex justify-around md:min-w-full w-fit gap-7 md:gap-14 animation_brands" data-v-d8c4d8ba><!--[-->`);
      ssrRenderList(unref(main_brands).data, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img class="text-black aspect-auto object-cover hover:grayscale-0 transition-all duration-75 cursor-pointer h-[90px] min-w-[80px] rounded-md"${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/brands/${item == null ? void 0 : item.img_path}`)} alt="" data-v-d8c4d8ba${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
      ...
      _push(`<!--]--></div><div class="flex justify-around md:min-w-full w-fit gap-7 md:gap-14 animation_brands" data-v-d8c4d8ba><!--[-->`);
      ssrRenderList(unref(main_brands).data, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          onClick: ($event) => ("useRouter" in _ctx ? _ctx.useRouter : unref(useRouter))().push(
            _ctx.localePath({
      ...
      _push(`<!--]--></div></div><div class="xl:w-[1196px] mt-10 rounded-md overflow-hidden select-none w-full aspect-[21/10] mx-auto" data-v-d8c4d8ba>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d8c4d8ba"]]);
export {
  index as default
};
//# sourceMappingURL=index-5acd8058.js.map
