  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!props.show_filter) {
        _push(`<div class="lg:relative lg:top-0 md:bottom-auto bottom-0 md:pt-10 pt-20 overflow-auto fixed shadow-2xl top-0 z-40 md:h-fit h-screen px-3 py-3 pb-10 bg-slate-100 rounded-md p-4"><div><div class="md:text-2xl text-base uppercase font-bold text-[#44A4DB] font-alatsi mb-2">${ssrInterpolate(_ctx.$t("order"))}</div><div><!--[-->`);
...
//# sourceMappingURL=FilteredSidebar-b294f3b7.js.map
