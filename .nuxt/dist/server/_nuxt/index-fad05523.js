...
/* empty css                     */import { h as useI18n, a as useRouter } from "../server.mjs";
import "hookable";
import "destr";
import "devalue";
import "klona";
...
const _sfc_main = {
  ...
  async setup(__props) {
    let __temp, __restore;
    const { locale } = useI18n();
    const { data: rating } = ([__temp, __restore] = withAsyncContext(() => useMyFetch(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-0861fbb4><div class="xl:w-[1196px] rounded-md overflow-hidden select-none w-full aspect-[21/10] mx-auto" data-v-0861fbb4>`);
      _push(ssrRenderComponent(_component_MainSwiper, null, null, _parent));
      _push(`</div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-0861fbb4><div class="flex justify-between" data-v-0861fbb4><p class="font-alatsi font-medium md:text-4xl text-xl text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[14px]" data-v-0861fbb4>${ssrInterpolate(_ctx.$t("categories"))}</p><div class="flex cursor-pointer items-center" data-v-0861fbb4><p class="font-alatsi font-medium inline md:text-3xl text-lg text-[#3C4242]" data-v-0861fbb4>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-0861fbb4></div></div><div class="md:h-[358px] h-[250px] md:mt-7 mt-1" data-v-0861fbb4><div class="block md:hidden" data-v-0861fbb4>`);
      ...
      _push(`</div></div></div><div class="block xl:w-[1238px] md:w-full w-full mx-auto mt-4 md:mt-[100px]" data-v-0861fbb4>`);
      _push(ssrRenderComponent(_component_MainInfo, {
        rating: (_a = unref(rating)) == null ? void 0 : _a.data
      }, null, _parent));
      _push(`</div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-0861fbb4><div class="flex justify-between" data-v-0861fbb4><p class="font-alatsi font-medium md:text-4xl text-xl text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[14px]" data-v-0861fbb4>${ssrInterpolate(_ctx.$t("latest_products"))}</p><div class="flex cursor-pointer items-center" data-v-0861fbb4><p class="font-alatsi font-medium inline md:text-3xl text-lg text-[#3C4242]" data-v-0861fbb4>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-0861fbb4></div></div><div class="block md:h-auto h-auto md:mt-7 mt-3" data-v-0861fbb4><div class="md:block hidden" data-v-0861fbb4>`);
      ...
      _push(`</div></div></div><div class="block h-auto xl:w-[1238px] w-screen mx-auto md:mt-[92px]" data-v-0861fbb4><div class="flex justify-center" data-v-0861fbb4><p class="font-alatsi font-medium md:text-4xl text-xl text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[14px]" data-v-0861fbb4>${ssrInterpolate(_ctx.$t("specials"))}</p></div><div class="h-auto w-full md:mt-7 mt-3" data-v-0861fbb4>`);
      _push(ssrRenderComponent(_component_HeroSpecials, {
        specials: unref(special_categories).data,
        class: ""
      }, null, _parent));
      _push(`</div></div><div class="block xl:w-[1238px] w-full mx-auto md:mt-[92px] mt-4" data-v-0861fbb4><div class="flex justify-between" data-v-0861fbb4><p class="font-alatsi font-medium md:text-4xl text-xl text-[#3C4242] border-l-[6px] border-[#8A33FD] pl-[14px]" data-v-0861fbb4>${ssrInterpolate(_ctx.$t("special_products"))}</p><div class="flex cursor-pointer items-center" data-v-0861fbb4><p class="font-alatsi font-medium inline md:text-3xl text-lg text-[#3C4242]" data-v-0861fbb4>${ssrInterpolate(_ctx.$t("view_all"))}</p><img class="inline h-[34px]" height=""${ssrRenderAttr("src", _imports_0)} alt="" data-v-0861fbb4></div></div><div class="block md:h-auto h-auto md:mt-7 mt-1" data-v-0861fbb4><div class="md:block hidden" data-v-0861fbb4>`);
      _push(ssrRenderComponent(_component_HeroSwiperProduct, {
      ...
      _push(`</div></div></div><div class="flex items-center gap-7 md:gap-14 2xl:w-[1440px] w-screen overflow-hidden mx-auto mt-4 md:mt-[92px] h-[125px]" data-v-0861fbb4><div class="flex justify-around md:min-w-full w-fit gap-7 md:gap-14 animation_brands" data-v-0861fbb4><!--[-->`);
      ssrRenderList(unref(main_brands).data, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<img class="text-black aspect-auto object-cover hover:grayscale-0 transition-all duration-75 cursor-pointer h-[90px] min-w-[80px] rounded-md"${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/brands/${item == null ? void 0 : item.img_path}`)} alt="" data-v-0861fbb4${_scopeId}>`);
            } else {
              return [
                createVNode("img", {
      ...
      _push(`<!--]--></div><div class="flex justify-around md:min-w-full w-fit gap-7 md:gap-14 animation_brands" data-v-0861fbb4><!--[-->`);
      ssrRenderList(unref(main_brands).data, (item) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          onClick: ($event) => ("useRouter" in _ctx ? _ctx.useRouter : unref(useRouter))().push(
            _ctx.localePath({
      ...
      _push(`<!--]--></div></div><div class="xl:w-[1196px] mt-10 rounded-md overflow-hidden select-none w-full aspect-[21/10] mx-auto" data-v-0861fbb4>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0861fbb4"]]);
export {
  index as default
};
