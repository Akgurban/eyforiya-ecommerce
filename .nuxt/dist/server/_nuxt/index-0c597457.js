...
const HeroSwiperVideo_vue_vue_type_style_index_0_scoped_2e57f858_lang = "";
const _sfc_main$1 = {
          ...
          if (_push2) {
            ...
            ssrRenderList(unref(video).data, (item) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<video class="w-full h-full object-cover z-[1]" autoplay loop data-v-2e57f858${_scopeId2}><source${ssrRenderAttr("src", `http://duypbaha.com.tm/api/v1/uploads/videos/${item == null ? void 0 : item.video_path}`)} alt="" data-v-2e57f858${_scopeId2}></video>`);
                  } else {
                    return [
                      createVNode("video", {
...
const __nuxt_component_6 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-2e57f858"]]);
...
//# sourceMappingURL=index-0c597457.js.map
