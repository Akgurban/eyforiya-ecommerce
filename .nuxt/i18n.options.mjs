export const localeCodes = ["tm","en","ru"]

export const localeMessages = {
  "tm": [{ key: "../lang/tm.json", load: () => import("../lang/tm.json" /* webpackChunkName: "lang_tm_json_tm_json" */) }],
...
export const additionalMessages = Object({"tm":[],"en":[],"ru":[],})
...
export const resolveNuxtI18nOptions = async (context) => {
 ...
 const vueI18nConfigLoader = async (loader) => {
  ...
  nuxtI18nOptions.locales = [Object({"code":"tm","file":"tm.json","hash":"b7b2d7aa","type":"static"}),Object({"code":"en","file":"en.json","hash":"38175145","type":"static"}),Object({"code":"ru","file":"ru.json","hash":"fb4504ec","type":"static"})]
...
export const nuxtI18nInternalOptions = Object({__normalizedLocales: [Object({"code":"tm","file":"tm.json","hash":"b7b2d7aa","type":"static"}),Object({"code":"en","file":"en.json","hash":"38175145","type":"static"}),Object({"code":"ru","file":"ru.json","hash":"fb4504ec","type":"static"})]})
