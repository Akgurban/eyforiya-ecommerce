  ...
  <div class="2xl:w-[1440px] xl:screen w-[90%] mx-auto">
    ...
    >
      <NuxtLink
        ...
        "
        class="group md:gap-6 w-full product_item mb-3 hover:shadow-none md:hover:shadow-hero hover:bg-[#D9D9D940] transition-all ease-in-out duration-200 rounded-xl flex flex-col justify-between items-center"
      >
        <img
